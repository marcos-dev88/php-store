...
<!--=========================== END MODAL ==================================-->
        ...
        <input id='userNameInput' type='hidden' value="<?php echo $_SESSION['user'] ?>"/>
        <nav class="navbar navbar-dark" style="background-color: #333231;">
            ...
            <button class='btn-php-store' data-toggle='modal' data-target='#changePasswordM' style='margin-left: 79%;'>Alterar Senha</button>
